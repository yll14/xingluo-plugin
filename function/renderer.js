...
export default async function (path, params, cfg) {
  ...
  let data = {
    ...
    sys: {
      ...
      copyright: `Yunzai-Bot<span class="version">${lobal.XINGLUO.Version.yunzai}</span> & ${PluginName_zh}<span class="version">${lobal.XINGLUO.PluginVersion}</span>&
        ${lobal.XINGLUO.PluginAuthor}`,
    },
    quality: 100,
  };
