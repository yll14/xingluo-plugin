...
let PluginloadingconsolecharacterdrawingswitchDONE =
  config.Pluginloadingconsolecharacterdrawingswitch[0];
let PluginloadingconsolecharacterdrawingswitchERROR =
  config.Pluginloadingconsolecharacterdrawingswitch[1];
...
if (!initMsg.boolean) {
  if (PluginloadingconsolecharacterdrawingswitchERROR) {
    ...
    logger.error(
      chalk.red("  * ======\`-.____\`-.___\\_____/___.-\`____.-'======"),
    );
    logger.error(chalk.red("  * \`=---='"));
    logger.error(
      chalk.red("  *          ............................................."),
...
if (
  ...
  logger.warn(
    chalk.red("         .\"\"  ' <  '.___\\_<|>_/___.' >'\"\".          "),
  );
  logger.warn(
    chalk.red("       | | :  ' - \\'.;'\\ _ /';.'' -  ' : | |        "),
  );
  logger.warn(
    chalk.red("         \\  \\  '_.   \\_ __\\ /__ _/   .-'' /  /        "),
  );
  logger.warn(
    chalk.red("    ====='-.____'.___ \\_____/___.-''___.-''=====     "),
  );
  logger.warn(
    chalk.red("                       '=---='                      "),
  );
